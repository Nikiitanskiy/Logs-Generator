...
class HTTP_logs(Logs):
    ...
    def __init__(self, get_resources=0, post_resources=0):
        if get_resources != 0:
    ...
    def _generate_logs(self):
        ...
        while True:
            ...
            if choice == "GET":
                gen = requests.get(random.choice(self.GET_resources))
            else:
                gen = requests.post(random.choice(self.POST_resources))
